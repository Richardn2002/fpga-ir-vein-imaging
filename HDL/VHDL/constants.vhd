PACKAGE constants IS
    ...
    CONSTANT INPUT_LEN : NATURAL := INPUT_X * INPUT_Y;
    CONSTANT INPUT_ADDR_BITS : NATURAL := 14;
    ...
    CONSTANT CLAHE_MAPPING_LEN_ALL_PATCHES : NATURAL := CLAHE_PATCH_X_NUM * CLAHE_PATCH_Y_NUM * 256;
    CONSTANT CLAHE_MAPPING_ADDR_BITS_ALL_PATCHES : NATURAL := 12; -- 256*16

    CONSTANT CLAHE_OUTPUT_LEN : NATURAL := (INPUT_X - CLAHE_PATCH_X) * (INPUT_Y - CLAHE_PATCH_Y);
    ...
    CONSTANT HESSIAN_INPUT_ADDR_BITS : NATURAL := 14;
    CONSTANT HESSIAN_OUTPUT_ADDR_BITS : NATURAL := 13;
